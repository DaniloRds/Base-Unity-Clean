...
local gps = {}
function src.spawnVehicle(vehname,vehengine,vehbody,vehfuel,damageData,inroad,custom,color)
	if inroad == 0 then
		local checkslot = 1
...
function src.deleteVehicle(vehicle)
    if IsEntityAVehicle(vehicle) then
        ...
        vSERVER.tryDelete(vehcarro, vehengine, vehbody, vehfuel, vehname, placa, damageData)
    end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- SAVE CAR STATUS
